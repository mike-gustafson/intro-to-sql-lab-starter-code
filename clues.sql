...
SELECT name
FROM cities
WHERE countrycode = (SELECT code FROM countries WHERE name = 'San Marino')
AND name != 'San Marino';
...
SELECT name
FROM cities
WHERE name LIKE 'San Mar%'
AND name != 'San Marino';

SELECT name FROM countries
WHERE code = (SELECT countrycode FROM cities WHERE name LIKE 'San Mart%');
...
SELECT name 
FROM cities
WHERE id = (SELECT capital FROM countries WHERE name = 'Mexico');
